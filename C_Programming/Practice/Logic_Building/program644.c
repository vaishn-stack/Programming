...
{   
    ...
    while(1)
    {
        ...
        else if(iCount == 3)
        {
            ...
            {
                iRet = CreateFile(Command[1], atoi(Command[2]));  // atoi - convert ascii value into integer
                ...
                {
                    printf("Error : Unable to create new file.\n");
                    printf("Baecause Parameters of command are invalid.\n");
